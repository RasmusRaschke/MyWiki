...
Let $(X,A)$ be a pair of [[topological space|topological spaces]]. The <ins>relative chain complex</ins> of $(X,A)$ is defined by
$$
...
**Remarks.**
1. Instead of describing relative chain complexes as [[relation#Equivalence Relation|quotients]], we can equivalently define them as free abelian group generated by all [[singular simplex|$n$-simplices]] $\beta: \Delta^n \to X$ whose image is not completely contained in $A$.
